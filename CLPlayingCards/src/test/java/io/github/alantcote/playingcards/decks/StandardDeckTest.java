...
public class StandardDeckTest {
	...
	public void testAddCards() {
		...
		StandardDeck fixture = new StandardDeck() {
			/* (non-Javadoc)
			 * @see io.github.alantcote.playingcards.Deck#add(io.github.alantcote.playingcards.Card)
			 */
			@Override
			...
			/* (non-Javadoc)
			 * @see io.github.alantcote.playingcards.decks.BridgeDeck#newCard(io.github.alantcote.playingcards.Rank, io.github.alantcote.playingcards.Suit)
			 */
			@Override
	...
	public void testStandardDeck() {
		...
		StandardDeck fixture = new StandardDeck() {
			/* (non-Javadoc)
			 * @see io.github.alantcote.playingcards.decks.StandardDeck#addCards()
			 */
			@Override
